...
class Interface:
    def __init__(self, root):
        ...
        title_lbl = Label(bg_img, text="Facial Attendance System", font=("sans serif", 35, "bold"), bg="dark blue",
                          fg="white")
        title_lbl.place(x=0, y=0, width=750, height=60)

        img2 = Image.open(
            r"C:\Users\SaadAliKhan\Desktop\facial_recognition_system\Img\cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTA4L2FpMjQwODIzLTNkLXJlbWl4LWhpLTAwNy5qcGc.webp")
        img2 = img2.resize((220, 220), Image.Resampling.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        student_button = Button(bg_img, image=self.photoimg2, cursor="hand2",command=self.students_details)
        student_button.place(x=70, y=120, width=220, height=220)

        student_button_1 = Button(bg_img, text="Student Details", cursor="hand2",command=self.students_details,
                                  font=("sans serif", 15, "bold"), bg="royal blue", fg="white")
        ...
        facial_recognition_button_1 = Button(bg_img, text="Face Recognition", cursor="hand2",
                                             font=("sans serif", 15, "bold"), bg="royal blue", fg="white")
        ...
        attendance_button_1 = Button(bg_img, text="Attendance", cursor="hand2", font=("sans serif", 15, "bold"),
        ...
        training_data_button_1 = Button(bg_img, text="Data Training", cursor="hand2", font=("sans serif", 15, "bold"),
                                        bg="royal blue", fg="white")
        training_data_button_1.place(x=70, y=650, width=220, height=40)

        img6 = Image.open(
            r"C:\Users\SaadAliKhan\Desktop\facial_recognition_system\Img\gallery-minimal-vector-line-icon-3d-button-isolated-black-background-premium-vector_570929-1676.jpg")
        ...
        picture_button_1 = Button(bg_img, text="Pictures", cursor="hand2", font=("sans serif", 15, "bold"),
                                  bg="royal blue", fg="white")
        picture_button_1.place(x=350, y=650, width=220, height=40)

        img7 = Image.open(
            r"C:\Users\SaadAliKhan\Desktop\facial_recognition_system\Img\power-button-computer-laptop-featured.jpg")
